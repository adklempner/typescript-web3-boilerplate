...
import * as StateMachineBuilderArtifact from '../src/artifacts/StateMachineBuilder.json';


import { Artifact } from './types';

export const artifacts = {
    StateMachineBuilderArtifact: (StateMachineBuilderArtifact as any) as Artifact,
